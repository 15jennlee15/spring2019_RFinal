...
Let's make a function that outputs descriptives for a given variable.  This is useful and can be used with any dataset that has a numerical variable.  To make the function effective, we should include a meaningful name, useful error messages, and make it genralizable to any dataset.
