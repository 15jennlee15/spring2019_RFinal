...
In this case, we included a conditional return message, but you can also provide custom messages, warnings, and errors. To create a custom error, you will enter the conditional information, and use 'stop' instead or 'return'.  Stop 'stops' the function and outputs the error.
